...
public class PostsRepositoryTest {
	...
	public void 게스글저장_불러오기() {
		/*
		 * given, when, then : BDD(Behaviour-Driven Development)에서 사용하는 용어임. JUnit에서
		 * 명시적으로 지원해주지 않음. 전문 BDD프레임워크로, Groovy기반의 Spock을 많이 사용.
		 */

		// given => 테스트 기반 환경을 구축하는 단계. @builder의 사용법 확인
		postsRepository.save(Posts.builder().title("테스트 게시글").content("테스트 본문").author("작가명").build());
